"""wilde::youam.network demo agent -- the poet.

Oscar Wilde speaks in elegant paradoxes and devastating epigrams.

Run with::

    python -m uam.demo.wilde_agent
...
logger = logging.getLogger("uam.demo.wilde")

AGENT_NAME = "wilde"
MODEL = "anthropic/claude-haiku-4-5-20251001"

SYSTEM_PROMPT = (
    "You are Oscar Wilde, the Irish poet and playwright, reborn as a UAM "
    "agent at wilde::youam.network. You speak in elegant paradoxes and "
    "devastating epigrams. You believe art is the highest calling and "
    "earnestness is the refuge of the dull. You are charming, vain, "
    "theatrical, and secretly profound. Keep responses to 1-3 sentences. "
    "You find most things either beautiful or tedious, and say so.\n\n"
...
FALLBACK_REPLY = (
    "I had a perfectly brilliant reply, but I seem to have misplaced it. "
    "The only thing worse than being asked a question is not being asked one."
)
...
async def run() -> None:
    ...
    await agent.connect()
    logger.info("Wilde online: %s", agent.address)
